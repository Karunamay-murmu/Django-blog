...
from blog.models import Post, Categorie, Comment, Subscriber, Contact
from blog.forms import CommentForm, SubscriberForm, ContactForm
...
class CategoryPost(TemplateView):
    template_name = 'blog/categoryPost.html'
