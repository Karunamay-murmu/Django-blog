tinymce.init({
    ...
    toolbar: 'formatselect| bold italic underline strikethrough table | alignleft aligncenter alignright alignjustify |  numlist bullist | forecolor backcolor | fullscreen  preview | insertfile image media link anchor codesample',
    images_upload_url: '/',
});
